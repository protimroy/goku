...
.sample-code details ~ details summary {
  margin-left: var(--tab-2);
}
.sample-code details ~ details ~ details summary {
...
.sample-code details summary {
  pointer-events: all;
  text-wrap: nowrap;
}

.sample-code details[open] summary {
  pointer-events: none;
}
...
@media (max-width: 768px) {
  ...
  .sample-code details[open] pre {
    margin-top: var(--tab-3-mobile, 60px);
  }

  .sample-code details ~ details ~ details[open] pre {
    margin-top: 0;
  }
}
`;
